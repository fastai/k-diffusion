...
def main(
    ...
    sampler:str='sample_lms',  # sample_lms, sample_dpm_2, or sample_euler
):
    ...
    def sample_fn(n):
        ...
        kwargs = {'s_churn':churn} if churn else {}
        return getattr(K.sampling, sampler)(model, x, sigmas, **kwargs)
